...
description = "Creating a StorNext Filesystem (cvfs v4.3 or earlier) You may have just provisioned some new DDN 9900 LUNs&nbsp;or otherwise added new storage to your StorNext based SAN. &nbsp;You now need to create the filesystem. Prerequisites: StorNext MDS/MDC (MetaData Server/Controller) in this example this will be built on RHEL A LUN presented to the MDS/MDC"
slug = "[SLUG]"
authors = [ "Ivan Lawrence" ]
tags = [ "nerdler" ]
categories = []
externalLink = "https://nerdler.ivanlawrence.com/2013/09/creating-stornext-filesystem-cvfs-v43.html"
series = [ ]
+++
